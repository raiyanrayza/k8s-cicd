			...
			<div class="text-center">
				...
				if ( $blog_filter_all == "yes" ) {
					if ( $blog_multi_filter == "no" ) { ?>
						<li id="all" class="snip0047 active" data-filter="all"><span style="pointer-events: none;"><?php _e("All", BF_TXTDM); ?></span><i style="pointer-events: none;" class="fa fa-check"></i></li>
					<?php 
					} else if ( $blog_multi_filter == "yes" ) { ?>
						<li id="filter-all" class="snip0047 filter-active" data-multifilter="all"><span style="pointer-events: none;"><?php _e("All", BF_TXTDM); ?></span><i style="pointer-events: none;" class="fa fa-check"></i></li>
						<?php 
					}
				}
				...
				if ( $blog_multi_filter == "no" ) { ?>
					<li id="<?php echo $term->term_id; ?>" class="snip0047" value="<?php echo $term->term_id; ?>" data-filter="<?php echo $term->term_id; ?>"><span style="pointer-events: none;"><?php _e($term->name, BF_TXTDM); ?></span><i style="pointer-events: none;" class="fa fa-check"></i></li>
					<?php 
				} else if ( $blog_multi_filter == "yes" ) { ?>
					<li id="<?php echo $term->term_id; ?>" class="snip0047" value="<?php echo $term->term_id; ?>" data-multifilter="<?php echo $term->term_id; ?>"><span style="pointer-events: none;"><?php _e($term->name, BF_TXTDM); ?></span><i style="pointer-events: none;" class="fa fa-check"></i></li>
					<script>
	...
	<div id="bf_gallery_1" class="filtr-container filters-div ">
		...
		while ( $custom_query->have_posts()) : $custom_query->the_post();
			...
			<div style="opacity:0;" id="bf_<?php echo get_the_ID(); ?>" data-category="<?php echo $keys; ?>" data-sort="<?php echo $filter_value->name; ?>" class=" pfg_theme_1 filtr-item filtr_item_1 single_one <?php echo $blog_col_large_desktops; ?> <?php echo $blog_col_desktops; ?> <?php echo $blog_col_tablets; ?> <?php echo $blog_col_phones; ?>">
				<figure class="snip1216 hvr-shadow-radial">
						...
						if($blog_title_below_image == "no"){ 
							if($blog_title == "yes"){ 
								...
								<?php
									...
									<a href="<?php echo get_day_link( $year, $month, $day ); ?>"><div class="date"><span class="day"><?php echo $day; ?></span><span class="month"><?php echo $Month; ?></span></div></a>
									<h3 class="blog_title"><?php echo ucwords(the_title()); ?></h3>
								<?php 
								} 
							} 
