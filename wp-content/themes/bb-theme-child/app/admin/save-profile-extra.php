...
function pacess_save_user_large_details_function() {
    /**
	...
	if(empty($_POST['action']) && $_POST['action'] != 'edit_save_profile_data'){
		return true;
	}
...
/*---------*/
	...
	if( isset($_POST['redirect']) && !empty($_POST['redirect']) ){
		...
		wp_safe_redirect( admin_url('users.php?page=edit-user-large-details&user_id='.$user_id) );
		exit;		
	}
}
// add_action( 'admin_post_nopriv_edit_save_profile_data', 'pacess_save_user_large_details_function' );
add_action( 'admin_post_edit_save_profile_data', 'pacess_save_user_large_details_function' );