...
if ( 'none' !== $layout ) {
	...
	if ( '1-col' === $layout ) {
		...
		echo '<div class="' . FLLayout::get_col_classes( array( 'sm' => 4, 'md' => 4 ) ) . ' text-left clearfix">'; // @codingStandardsIgnoreLine
	}
	...
	if ( 'text' === $col_layout || 'text-social' === $col_layout ) {
		echo '<div class="fl-page-bar-text fl-page-bar-text-1">';
		echo $print_shortcode = do_shortcode( '[member_login_logout]' );
		echo '</div>';
