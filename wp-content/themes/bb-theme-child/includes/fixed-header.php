	...
	<div class="fl-page-header-wrap">
		<div class="fl-page-header-container <?php FLLayout::container_class(); ?>">
			<div class="fl-page-header-row <?php FLLayout::row_class(); ?>">
				<div class="<?php FLLayout::col_classes( array( 'sm' => 12, 'md' => 2 ) ); // @codingStandardsIgnoreLine ?> fl-page-logo-wrap">
					<div class="fl-page-header-logo">
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php FLTheme::fixed_header_logo(); ?></a>
					</div>
				</div>
				<div class="<?php FLLayout::col_classes( array( 'sm' => 12, 'md' => 10 ) ); // @codingStandardsIgnoreLine ?> fl-page-fixed-nav-wrap">
