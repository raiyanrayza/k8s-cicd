...
/* layout.html */
class __TwigTemplate_2340b4fa82f35451951ee8e04265001fb72cd76745b4f7355814cba4733791f8 extends \MailPoetVendor\Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        // line 118
        if ((\MailPoetVendor\twig_get_attribute($this->env, $this->source, \MailPoetVendor\twig_get_attribute($this->env, $this->source, ($context["mailpoet_api_key_state"] ?? null), "data", [], "any", false, false, false, 118), "support_tier", [], "any", false, false, false, 118) == "premium")) {
            // line 119
            echo "  ";
...
";
    ...
    {
        return new Source("", "layout.html", "/home4/rsanghvi/aibitz.com/paces/wp-content/plugins/mailpoet/views/layout.html");
    }
}
